...
if __name__ == "__main__":
    ...
    if is_windows:
        root_dir = 'D:/代码/SGL-Torch-main-aug_agree_mod_new_feature_sim_pretrain/SGL-Torch-main/'
        data_dir = 'D:/代码/SGL-Torch-main-aug_agree_mod_new_feature_sim_pretrain/SGL-Torch-main/dataset/'
    else:
        root_dir = 'D:/代码/SGL-Torch-main-aug_agree_mod_new_feature_sim_pretrain/SGL-Torch-main/'
        data_dir = 'D:/代码/SGL-Torch-main-aug_agree_mod_new_feature_sim_pretrain/SGL-Torch-main/dataset/'
    # if is_windows:
